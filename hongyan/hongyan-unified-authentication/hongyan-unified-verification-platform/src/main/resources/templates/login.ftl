...
<head>
    ...
    <link rel="stylesheet" href="${request.contextPath}/static/ssoProperties/adminlte/plugins/iCheck/square/blue.css">
...
<script src="${request.contextPath}/static/ssoProperties/adminlte/plugins/iCheck/icheck.min.js"></script>
<script src="${request.contextPath}/static/ssoProperties/js/login.1.js"></script>
</html>